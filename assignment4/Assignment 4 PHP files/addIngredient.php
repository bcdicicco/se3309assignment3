...
<form action="http://localhost/addIngredient.php/" method="post">

    <b>Add a New Ingredient</b>

    <p>Ingredient No:
        <input type="text" name="ingredientNo" size="30" value="" />
    </p>

    <p>Ingredient Name:
        <input type="text" name="ingredientName" size="30" value="" />
    </p>

    <p>Date Of Purchase (YYYY-MM-DD):
        <input type="text" name="dateOfPurchase" size="30" value="" />
    </p>

    <p>Date Of Expiry (YYYY-MM-DD):
        <input type="text" name="dateOfExpiry" size="30" value="" />
    </p>
    ...
    <p>Quantity:
        <input type="text" name="quantity" size="30" maxlength="2" value="" />
    </p>

    <p>Supplier Number:
        <input type="text" name="supplierNo" size="30" maxlength="5" value="" />
    </p>
